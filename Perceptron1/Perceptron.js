var Perceptron = ( function() {
	 ...
	 * Metodos privados
	 */
	Perceptron.prototype.salidaObtenida = function( sinapsis ) {
		return sinapsis >= 0 ? 1 : 0;
	};

	Perceptron.prototype.asignarPesos = function() {
	...
	Perceptron.prototype.reajustarPesos = function( info ) {
		var len = this.pesos.length, i;
	...
	Perceptron.prototype.calcularSinapsis = function( info ) {
		var len = this.pesos.length, i;
		info.sinapsis = 0;
	...
	Perceptron.prototype.calcularError = function( info ) {
	 ...
	 * Getters y setters
	 */
	Perceptron.prototype.getPesos = function() {
		return this.pesos;
	};
